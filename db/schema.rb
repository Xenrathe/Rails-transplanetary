...
ActiveRecord::Schema[7.0].define(version: 2023_11_21_154900) do
  ...
  create_table "spaceports", force: :cascade do |t|
    ...
    t.integer "year_founded", default: 2000, null: false
    t.text "description", default: "Description", null: false
    t.string "img_url", default: "image.png", null: false
  end
